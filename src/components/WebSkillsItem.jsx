...
const WebSkillsItem = ({skillIcon}) => {
    ...
    return (
        <div className=' shadow-calm-green max-w-2 shadow-md  rounded-lg p-6 fill-white hover:fill-calm-green '>
            <SkillItem className=" text-center w-full h-full max-h-24 "/>
