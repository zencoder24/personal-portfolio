...
const Home = () => {
    return (
        <div className=' absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 space-y-1'>
            ...
            <h2 className='text-center uppercase font-bold text-3xl text-white '>I'm <span className='text-calm-green'>Rod Garland</span></h2>
            <p className='font-bold text-calm-green uppercase text-center text-xl'>Full Stack Web Developer</p>
