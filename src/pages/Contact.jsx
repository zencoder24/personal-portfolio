...
const Contact = () => {
    return (
        <section className='py-40 px-10 flex flex-col '>
            <h3 className=' text-center text-white font-bold uppercase text-sm'>This is how to</h3>
            <h1 className=' text-white uppercase font-bold text-center pb-4 mx-0 my-auto text-4xl'>Contact <span className='text-calm-green'>Me</span></h1>
            <div className="contact-container flex flex-col md:flex-row md:gap-20 md:justify-center">
                <div className="left md:max-w-[500px] md:w-full">
                   ...
                   <ContactItem icon='linkedIn' contactData='linkedin.com/in/rodderick-garland-58ba19160/'/>
                </div>
