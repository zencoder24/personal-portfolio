    ...
    <main className=" my-32 flex flex-col gap-y-16 text-gray-200">
      ...
      <section id="about-me ">
        <div id="about-me-title" className="mb-12">
          <h2 className=" font-nunito text-4xl font-bold md:text-5xl">
            About Me
          </h2>
        </div>
      ...
      <section id="tech-used">
        ...
        <div id="tech-wrapper" className="">
          <div id="about-skills" className="">
            <h3 className="mb-4 font-nunito text-2xl font-semibold">Skills:</h3>
          ...
          <div id="about-tools" className="mt-8">
            <h3 className="mb-4  font-nunito text-2xl font-semibold">Tools:</h3>
            <ul className="mt-2 flex flex-wrap gap-4">
              {toolsData.map((tool) => {
                return (
